...
const TIERS: Tier[] = [
  { number: "01", name: "Slow PC Tune-Up", scope: "Startup cleanup, driver updates, drive health and malware scan.", price: "2,500 KSh", timing: "30 minutes", bestFor: "A sluggish laptop or desktop" },
